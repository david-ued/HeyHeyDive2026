      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <div className="rounded-lg border border-gray-200 bg-white p-6 lg:col-span-2">
          ...
          <dl className="grid gap-y-3 gap-x-6 sm:grid-cols-2">
            ...
            <Field label="Email"><a className="text-coral hover:underline" href={`mailto:${booking.contact_email}`}>{booking.contact_email}</a></Field>
            <Field label="電話">{booking.contact_phone ?? '—'}</Field>
